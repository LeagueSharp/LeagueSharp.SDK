...
namespace LeagueSharp.CommonEx.Core.Network
{
    ...
    public class Packet
    {
        ...
        /// </summary>
        public static Packet BuyItem = new Packet(0x2B, PacketChannel.C2S);

        /// <summary>
        ///     Sent on moving camera or zooming.
        /// </summary>
        public static Packet Camera = new Packet(0xC5, PacketChannel.C2S, PacketProtocolFlags.NoFlags);

        /// <summary>
        ///     Sent on a spell cast
        /// </summary>
        public static Packet CastSpell = new Packet(0xE9, PacketChannel.C2S);
        ...
        ///     Sent on an emote
        /// </summary>
        public static Packet Emote = new Packet(0x0A, PacketChannel.C2S);

        /// <summary>
        ///     Sent on heartbeat
        /// </summary>
        public static Packet HeartBeat = new Packet(0x124, PacketChannel.GamePlay);

        /// <summary>
        ///     Sent on using objects(Clicking thresh lantern)
        /// </summary>
        public static Packet InteractObject = new Packet(0x10B, PacketChannel.C2S);

        /// <summary>
        ///     Sent on an issue order(move to, hold position)
        /// </summary>
        public static Packet IssueOrder = new Packet(0xD2, PacketChannel.C2S);

        /// <summary>
        ///     Sent on leveling spell
        /// </summary>
        public static Packet LevelSpell = new Packet(0xC9, PacketChannel.C2S);

        /// <summary>
        ///     Sent on locking camera.
        /// </summary>
        public static Packet LockCamera = new Packet(0xC9, PacketChannel.C2S);

        /// <summary>
        ///     Sent on pausing games(tournament mode, custom games)
        /// </summary>
        public static Packet PauseGame = new Packet(0x10E, PacketChannel.C2S);
        ...
        /// </summary>
        public static Packet ResumeGame = new Packet(0xAD, PacketChannel.C2S);

        /// <summary>
        ///     Sent when opening score board.
        /// </summary>
        public static Packet ScoreScreen = new Packet(0x75, PacketChannel.C2S);

        /// <summary>
        ///     Sent on selling an item.
        /// </summary>
        public static Packet SellItem = new Packet(0x51, PacketChannel.C2S);

        /// <summary>
        ///     Sent on left clicking target.
        /// </summary>
        public static Packet SetTarget = new Packet(0x101, PacketChannel.C2S);

        /// <summary>
        ///     Sent on pressing the undo button in the shop.
        /// </summary>
        public static Packet UndoBuy = new Packet(0x109, PacketChannel.C2S);

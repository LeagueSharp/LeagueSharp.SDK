...
namespace LeagueSharp.SDK.Core.Wrappers
{
    ...
    public static class Damage
    {
        ...
        /// <summary>
        ///     Enumeration that contains items that deal damage.
        /// </summary>
        public enum DamageItems
        {
            /// <summary>
            ///     <c>Hextech Gunblade</c>
            /// </summary>
            HextechGunblade, 

            /// <summary>
            ///     <c>Blade of the Ruined King</c>
            /// </summary>
            BladeOfTheRuinedKing, 

            /// <summary>
            ///     <c>Bilgewater Cutlass</c>
            /// </summary>
            BilgewaterCutlass, 
            ...
            /// <summary>
            ///     <c>Liandry's Torment</c>
            /// </summary>
            LiandrysTorment
        }

        /// <summary>
        ///     Enumeration that contains <c>summoner</c> spells that deal damage
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the JSON file that contains attack passives.
        /// </summary>
        internal static JObject AttackPassiveFile { get; set; }

        /// <summary>
        ///     Gets or sets the DDragon JSON file.
        /// </summary>
        internal static JObject SpellDamageFile { get; set; }
        ...
        /// </summary>
        /// <param name="source">
        ///     <see cref="Obj_AI_Base" /> where the damage is coming from.
        /// </param>
        /// <param name="target">
        ///     <see cref="Obj_AI_Base" /> where the damage is going to.
        /// </param>
        ...
        /// </param>
        /// <returns>
        ///     The real damage done after calculations.
        /// </returns>
        ...
        /// <param name="source"><see cref="Obj_AI_Base" /> where the damage is coming from.</param>
        /// <param name="target"><see cref="Obj_AI_Base" /> where the damage is going to.</param>
        /// <param name="includePassive">Includes passives, such as <c>Botrk</c>, and masteries.</param>
        ...
        /// <param name="source"><see cref="Obj_AI_Base" /> where the damage is coming from.</param>
        /// <param name="target"><see cref="Obj_AI_Base" /> where the damage is going to.</param>
        /// <param name="damageItem">The Item</param>
        ...
        /// <summary>
        ///     Gets the <c>summoner</c> spell damage.
        /// </summary>
        /// <param name="source"><see cref="Obj_AI_Base" /> where the damage is coming from.</param>
        /// <param name="target"><see cref="Obj_AI_Base" /> where the damage is going to.</param>
        /// <param name="spell">
        ///     <see cref="SummonerSpell" /> instance
        /// </param>
        /// <returns><c>Summoner</c> spell damage</returns>
        ...
        /// <summary>
        ///     Load Attack Passives.
        /// </summary>
        /// <param name="attackPassives">
        ///     The attack passives.
        /// </param>
        private static void LoadAttackPassives(ref List<PassiveDamage> attackPassives)
        {
            var p = new PassiveDamage
                        {
                            ...
                            IsActive =
                                (source, target) =>
                                (source.HasBuff("AatroxWPower") && source.HasBuff("AatroxWONHPowerBuff")), 
            ...
            p = new PassiveDamage
                    {
                        ChampionName = "MissFortune", IsActive = (source, target) => source.HasBuff("MissFortunePassive"), 
                        GetDamage =
                            (source, target) =>
                            (float)
                            source.CalculateDamage(
            ...
            p = new PassiveDamage
                    {
                        ChampionName = "Nasus", IsActive = (source, target) => source.HasBuff("SiphoningStrike"), 
            ...
            p = new PassiveDamage
                    {
                        ChampionName = "Teemo", IsActive = (source, target) => source.HasBuff("Toxic Attack"), 
                        GetDamage =
                            (source, target) =>
                            ((float)
                             source.CalculateDamage(
            ...
            p = new PassiveDamage
                    {
                        ChampionName = "TwistedFate", IsActive = (source, target) => source.HasBuff("Pick A Card Blue"), 
                        GetDamage =
                            (source, target) =>
            ...
            p = new PassiveDamage
                    {
                        ChampionName = "Vayne", IsActive = (source, target) => source.HasBuff("VayneTumble"), 
                        GetDamage = (source, target) => ((float)source.GetSpellDamage(target, SpellSlot.Q)), 
                    };
            attackPassives.Add(p);
                        ...
                        new DamageSpell
                            {
                                ...
                                Damage =
                                    (source, target, level) =>
                                    new double[] { 308, 462, 616 }[level]
                                    + 0.84 * source.FlatMagicDamageMod
                            }, 
                    });
                        ...
                        new DamageSpell
                            {
                                ...
                                Damage =
                                    (source, target, level) =>
                                    new double[] { 20, 65, 110, 155, 200 }[level]
                                    + 1 * source.FlatPhysicalDamageMod
                            }, 
                        ...
                        new DamageSpell
                            {
                                ...
                                Damage =
                                    (source, target, level) =>
                                    new double[] { 60, 140, 220, 300 }[level]
                                    + 0.6 * source.FlatMagicDamageMod
                            }, 
                    });
                        ...
                        new DamageSpell
                            {
                                ...
                                Damage =
                                    (source, target, level) =>
                                    new double[] { 12, 19, 26, 33, 40 }[level]
                        ...
                        new DamageSpell
                            {
                                ...
                                Damage =
                                    ...
                                    + 0.4 * source.FlatMagicDamageMod + 0.065 * source.MaxMana
                            }, 
                        ...
                        new DamageSpell
                            {
                                ...
                                Damage =
                                    (source, target, level) =>
                                    new double[] { 60, 95, 130, 165, 200 }[level]
                                    + 0.6 * source.FlatMagicDamageMod + 0.045 * source.MaxMana
                            }, 
                        ...
                        new DamageSpell
                            {
                                ...
                                Damage =
                                    ...
                                    + 0.35 * source.FlatMagicDamageMod + 0.01 * source.MaxMana
                            }, 
                    });
                        ...
                        new DamageSpell
                            {
                                ...
                                Damage =
                                    (source, target, level) =>
                                    (new[] { 4, 5.5, 7, 8.5, 10 }[level]
                                     + (source.FlatMagicDamageMod / 100)) / 100 * target.MaxHealth
                            }, 
                        ...
                        new DamageSpell
                            {
                                ...
                                Damage =
                                    ...
                                    + 0.75 * source.FlatMagicDamageMod
                                    + new[] { 4, 5.5, 7, 8.5, 10 }[level] / 100 * target.MaxHealth
                            }, 
                    });
        ...
        /// </param>
        /// <returns>
        ///     The returned damage modifier after passive flat mod
        /// </returns>
        ...
        internal class DamageSpell
        {
            ...
            /// <summary>
            ///     Gets or sets the calculated amount of damage the spell does.
            /// </summary>
            public double CalculatedDamage { get; set; }

            /// <summary>
            ///     Gets or sets <see cref="SpellDamageDelegate" />
            /// </summary>
            public SpellDamageDelegate Damage { get; set; }

            /// <summary>
            ///     Gets or sets the type of damage this spell deals.
            /// </summary>
            public DamageType DamageType { get; set; }

            /// <summary>
            ///     Gets or sets the slot of the spell.
            /// </summary>
            public SpellSlot Slot { get; set; }

            /// <summary>
            ///     Gets or sets the "stage" of the spell.
            /// </summary>
        ...
        internal class PassiveDamage
        {
            ...
            /// <summary>
            ///     Gets or sets <see cref="GetDamageD" />
            /// </summary>
            public GetDamageD GetDamage { get; set; }

            /// <summary>
            ///     Gets or sets <see cref="IsActiveD" />
            /// </summary>
            public IsActiveD IsActive { get; set; }

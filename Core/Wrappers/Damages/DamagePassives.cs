    ...
    public static partial class Damage
    {
        ...
        private static void CreatePassives()
        {
            AddPassiveAttack(
                ...
                DamageType.Physical,
                (hero, @base) =>
                hero.GetCritMultiplier() * hero.TotalAttackDamage * (hero.ChampionName == "Kalista" ? 0.9 : 1));
            AddPassiveAttack(
                string.Empty,
                ...
                switch (name)
                {
                    ...
                    case "Kindred":
                        AddPassiveAttack(
                            ...
                            (hero, @base) =>
                            Math.Min(
                                (0.125 * hero.GetBuffCount("kindredmarkofthekindredstackcounter")) * @base.Health,
                            ...
                            (hero, @base) =>
                                {
                                    ...
                                    if (@base.Type == GameObjectType.obj_AI_Hero && @base.HasBuff("ShenQSlow"))
                                    {

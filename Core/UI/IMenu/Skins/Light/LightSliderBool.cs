...
namespace LeagueSharp.SDK.Core.UI.IMenu.Skins.Light
{
    ...
    /// </summary>
    public class LightSliderBool : ADrawable<MenuSliderBool>
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="LightSliderBool" /> class.
        /// </summary>
        /// <param name="component">
        ///     The menu component
        /// </param>
        public LightSliderBool(MenuSliderBool component)
            : base(component)
        {
        }

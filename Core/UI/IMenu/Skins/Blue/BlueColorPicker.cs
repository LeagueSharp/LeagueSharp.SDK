namespace LeagueSharp.SDK.Core.UI.IMenu.Skins.Blue
{
    ...
    internal class BlueColorPicker : ADrawable<MenuColor>
    {
        ...
        /// </summary>
        private readonly VerticalAlphaSlider verticalAlphaSlider;

        /// <summary>
        ///     The VerticalColorSlider to change the color spectrum.
        /// </summary>
        private readonly VerticalColorSlider verticalColorSlider;
            ...
            : base(component)
        {
            ...
            this.verticalAlphaSlider.ColorSliderScroll += () =>
                {
                    tempHsl = this.colorBox.Hsl;

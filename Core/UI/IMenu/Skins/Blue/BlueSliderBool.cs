...
namespace LeagueSharp.SDK.Core.UI.IMenu.Skins.Blue
{
    ...
    /// </summary>
    public class BlueSliderBool : ADrawable<MenuSliderBool>
    {
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="BlueSliderBool" /> class.
        /// </summary>
        /// <param name="component">
        ///     The menu component
        /// </param>
        public BlueSliderBool(MenuSliderBool component)
            : base(component)
        {
        }
        ...
        public override void Draw()
        {
            ...
            Line.Draw(
                ...
                this.Component.BoolValue ? new ColorBGRA(0, 186, 255, 255) : new ColorBGRA(36, 36, 36, 255));
            Line.End();
            ...
            MenuSettings.Font.DrawText(
                ...
                centerX,
                centeredY,
                this.Component.BoolValue ? new ColorBGRA(0, 27, 41, 255) : MenuSettings.TextColor);
        }

...
namespace LeagueSharp.SDK.Core.Events
{
    ...
    public class InterruptableSpell
    {
        ...
        private static void InitializeSpells()
        {
            ...
            GlobalInterruptableSpellsList.Add(new InterruptableSpellData("OdinChannel", DangerLevel.Low));
            GlobalInterruptableSpellsList.Add(new InterruptableSpellData("OdinChannelBomb", DangerLevel.Low));
        ...
        public class InterruptableSpellData
        {
            ...
            ///     Does movement interrupt the spell
            /// </param>
            public InterruptableSpellData(string name, DangerLevel dangerLevel, bool movementInterrupts = true)
            {
                this.Name = name;
                this.DangerLevel = dangerLevel;
                this.MovementInterrupts = movementInterrupts;
